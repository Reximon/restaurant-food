        ...
        <main>
            ...
            <div class="tasks">
                <div class="profileEdit">
                    <form action="helpers/actualizar-datos.php" method="POST" class="form-profile">
                        <label for="nombre" class="labelProfile">Nombre: </label>
                        <input class="inputUpdate" type="text" name="nombre" value="<?=$_SESSION['usuario']['nombre']?>">

                        <label for="apellidos" class="labelProfile">Apellidos: </label>
                        <input class="inputUpdate" type="text" name="apellidos" value="<?=$_SESSION['usuario']['apellidos']?>">

                        <label for="email" class="labelProfile">Email:</label>
                        <input class="inputUpdate" type="email" name="email" value="<?=$_SESSION['usuario']['email']?>">

                        <input class="inputUpdate submited" type="submit" name="submit" value="Actualizar">
                    </form>
                </div>
            </div>
        </main>
